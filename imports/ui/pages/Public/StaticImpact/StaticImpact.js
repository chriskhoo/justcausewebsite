...
import { Jumbotron, Grid, Row, Col } from 'react-bootstrap';import ReportIconImage from '../../../components/ReportIconImage/ReportIconImage';
  ...
  <div className="static-impact">
    ...
    <div id='work'>
      <Grid>
        ...
        <Row>
          <Col xs={12} md={3} ><ReportIconImage image='/Logo_SSI.jpeg' large/></Col>
          <Col xs={12} md={9} >
        ...
        <Row>
          <Col xs={12} md={3} ><ReportIconImage image='/Logo_octava.jpeg' large/></Col>
          <Col xs={12} md={9} >
    ...
    <div id='clients'>
      <Grid>
        ...
        <Row>
          <Col xs={4} md={2} ><ReportIconImage image='/Logo_ADI.png' large/></Col>
          <Col xs={4} md={2} ><ReportIconImage image='/Logo_art_outreach.png' large/></Col>
          <Col xs={4} md={2} ><ReportIconImage image='/Logo_aware.jpeg' large/></Col>
          <Col xs={4} md={2} ><ReportIconImage image='/Logo_AWWA.png' large/></Col>
          <Col xs={4} md={2} ><ReportIconImage image='/Logo_babes.jpeg' large/></Col>
          <Col xs={4} md={2} ><ReportIconImage image='/Logo_cfs.png' large/></Col>
          <Col xs={4} md={2} ><ReportIconImage image='/Logo_magic.png' large/></Col>
          <Col xs={4} md={2} ><ReportIconImage image='/Logo_mercy_relief.jpeg' large/></Col>
          <Col xs={4} md={2} ><ReportIconImage image='/Logo_octava.jpeg' large/></Col>
          <Col xs={4} md={2} ><ReportIconImage image='/Logo_SSI.jpeg' large/></Col>
          <Col xs={4} md={2} ><ReportIconImage image='/Logo_talent_trust.jpg' large/></Col>
        </Row>
      </Grid>
    </div>
  </div>
