...
const NewReport = ({ history, loading, svcs, ctrys, t_grps, d_levels }) => (
  !loading ? (
    <div className="NewReport">
      <h4 className="page-header">New Report</h4>
      <ReportEditor history={history} svcs={svcs} ctrys={ctrys} t_grps= {t_grps} d_levels={d_levels} />
    </div>
  ) : <Loading />
);
...
export default createContainer(() => {
  ...
  return {
    loading: !svcsSubscription.ready() || !ctrySubscription.ready() || !t_grpsSubscription.ready() || !d_levelsSubscription.ready(),
