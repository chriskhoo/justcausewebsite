...
class ReportEditor extends React.Component {
  ...
  handleSubmit() {
    ...
    const { service_ids, country_id, type, charity_id, program_id, completed, data_collection, continuous_improvement, impact_framework, commentary, outcome_quotes } = this.form;
    ...
    const outputs = getFormElementsWithNewButton("output", { number: "string", description: "string" } , this.form);
    const outcomes = getFormElementsWithNewButton("outcome", { number: "string", description: "string" } , this.form);
