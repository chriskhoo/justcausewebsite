...
class CharityEditor extends React.Component {
  ...
  handleSubmit() {
    ...
    const {quote_1, quote_2, quote_3, facebook_likes_date, facebook_likes_number, media_article_1_title, media_article_1_source, media_article_1_date, media_article_1_summary, media_article_2_title, media_article_2_source, media_article_2_date, media_article_2_summary, media_article_3_title, media_article_3_source, media_article_3_date, media_article_3_summary, background_year } = this.form;
    ...
    chty.financial_info={
      ...
      rev_model_cash_donations_percent: Number(rev_model_cash_donations_percent.value),
